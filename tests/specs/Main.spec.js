...
describe('<FullHeader />', () => {
    ...
    context('subtitle', () => {
        it('should have h2 when subtitle passaed', () => {
    ...
    context('bgColor', () => {
        ...
        it('should have background-color equal #ccc when none is passed', () => {
            const wrapper = shallow(<FullHeader bgColor="#ddd" />);
    ...
    context('textColor', () => {
        ...
        it('should have text-color equal #222 when none is passed', () => {
            const wrapper = shallow(<FullHeader textColor="#222" />);
